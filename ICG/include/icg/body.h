...
namespace icg
{
     ...
     public:
          ...
          const std::vector<std::array<int, 3>> &mesh_vertex_indices() const;
          const std::vector<std::array<int, 3>> &mesh_texture_indices() const;
     ...
     private:
          ...
          // Calculated values
          std::vector<std::array<int, 3>> mesh_vertex_indices_{};
